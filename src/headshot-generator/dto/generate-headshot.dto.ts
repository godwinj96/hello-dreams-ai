...
export class GenerateHeadshotDto {
  ...
  @ApiPropertyOptional({
    description:
      'URL of the uploaded reference image (from the upload endpoint)',
    example:
      'https://cqdqicqzdhccuylzpyvn.supabase.co/storage/v1/object/sign/headshot-originals/...',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Alias for originalImageUrl',
    deprecated: true,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'Alias for personaType',
    deprecated: true,
  })
  @IsOptional()
  @IsString()
