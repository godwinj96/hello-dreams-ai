...
export class AddSuperuserRoleAndIsActive1769464066536
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."users_role_enum" ADD VALUE 'superuser'`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_usage_tracking_timestamp" ON "usage_tracking" ("createdAt")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_usage_tracking_module" ON "usage_tracking" ("module")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_usage_tracking_userId_timestamp" ON "usage_tracking" ("userId", "createdAt")`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "usage_tracking" DROP CONSTRAINT "FK_usage_tracking_user"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_usage_tracking_userId_timestamp"`,
    );
    await queryRunner.query(`DROP INDEX "public"."IDX_usage_tracking_module"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_usage_tracking_timestamp"`,
    );
