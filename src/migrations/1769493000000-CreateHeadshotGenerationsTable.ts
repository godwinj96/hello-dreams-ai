...
export class CreateHeadshotGenerationsTable1769493000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_headshot_generations_createdAt" ON "headshot_generations" ("createdAt")`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "headshot_generations" DROP CONSTRAINT "FK_headshot_generations_user"`,
    );

    // Drop indexes
    await queryRunner.query(
      `DROP INDEX "public"."IDX_headshot_generations_createdAt"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_headshot_generations_status"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_headshot_generations_userId"`,
    );
